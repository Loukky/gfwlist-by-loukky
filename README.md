...
# 文件说明
[list.txt](https://github.com/Loukky/gfwlist-by-loukky/blob/master/list.txt) 
```javascript copy
https://github.com/Loukky/gfwlist-by-loukky/blob/master/list.txt
```
使用明文方便对比列表的变化  
[gfwlist.txt](https://raw.githubusercontent.com/Loukky/gfwlist-by-loukky/refs/heads/master/gfwlist.txt) 
```javascript copy
https://raw.githubusercontent.com/Loukky/gfwlist-by-loukky/refs/heads/master/gfwlist.txt
```
则是通过base64转码过后的列表，一般使用这个即可
## Pac规则（来自bocchi810）
### 转换过程中可能会丢失部分规则
...
### Email to: gfwlistbyloukky#proton.me (replace # to @)
